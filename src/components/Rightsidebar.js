...
export default function Rightsidebar({ otheruser }) {
    return (
        <div className='w-[25%]'>
            ...
            <div className='p-4 bg-gray-100 rounded-2xl my-4'>
                <h1 className='font-bold text-lg'>Who to Follow</h1>
                {
                    otheruser?.map((otheruser) => {
                        return (
                            <div key={otheruser?._id} className='flex items-center justify-between my-3'>
                                ...
                                <button className='px-4 bg-black text-white py-1 rounded-full'>Profile</button>
                                </Link>
